...
import SObjectStreaming from '../sObjectStream.js';
import { ASYNC_OPERATION_CDC } from '../../common/constants.js';
import { type AsyncOperationResult, AsyncOperationStatus } from '../../common/types.js';
import type { AorOutputService } from '../../common/outputService/index.js';

export default class AsyncOpStreaming extends SObjectStreaming {
  private outputService: AorOutputService;

  public constructor(org: Org, wait: Duration, idToInspect: string, outputService: AorOutputService) {
